 ...
 * @method FluentIteratorInterface<array-key,Workspace> getWorkspaces(ISyncContext $ctx)
 *
 * @generated by lk-util
 * @salient-generate-command generate sync provider --magic --op='get,get-list' 'Lkrms\Time\Entity\Workspace'
 */
